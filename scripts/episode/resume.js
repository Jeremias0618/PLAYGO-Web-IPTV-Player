    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function showResumeNotification(time, onAccept, onCancel) {
            ...
            if (isPlyr) {
                ...
                notif.innerHTML = `
                    <span class="plyr-resume-notification__text">Reanudar episodio desde ${timeStr}?</span>
                ...
                notif.innerHTML = `
                    <span style="font-size:1.15rem;">¿Deseas continuar viendo <b>${episodeTitle}</b> desde ${timeStr}?</span>
